...
```
repo=git@github.com:jeff-hykin/better-latex-syntax.git defaultNixVersion=2.18.1 eval "$(curl -fsSL https://raw.githubusercontent.com/jeff-hykin/xome/refs/heads/master/setup.sh || wget -qO- https://raw.githubusercontent.com/jeff-hykin/xome/refs/heads/master/setup.sh)"
```
...
git clone https://github.com/jeff-hykin/better-latex-syntax.git
# cd into the repo
cd better-latex-syntax
# run nix develop
nix develop
```
